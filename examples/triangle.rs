use gl_window_provider::{GlWindowProvider, Renderer};
...
fn main() {
    ...
    let handler = GlWindowProvider::new(&event_loop).build_handler::<TriangleRenderer, ()>();
...
impl Deref for TriangleRenderer {
    type Target = gl::Gl;
